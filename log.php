    ...
    <div class="page-form">
        <div class="panel panel-blue">
			...
			//Mostramos los errores mandados por el GET en color rojo
			 if(isset($_GET["error"])){
				 if($_GET["error"]==1){ //Si el usuario o el password son incorrectos
					 echo "Usuario o Password incorrectos";
				}
				if($_GET["error"]==2){ //Si se intento acceder a alguna parte del sitio sin iniciar session
                    ...
                    <div class="form-group mbn">
                        <div class="col-lg-12" align="right">
                            <div class="form-group mbn">
                                ...
                                <div class="col-lg-9">
                                    <a href="Login.html" class="btn btn-default">Borrar</a>&nbsp;&nbsp;
